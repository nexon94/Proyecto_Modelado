...
Original file is located at
    https://colab.research.google.com/drive/1qebVnLfeHTV5Hufz6RrcGm8MNpxPg6ZW
"""
class Viaje:
...
# /set
    ...
    @property
    def npersona(self):
        '''devuelve el numero de personas'''
   ...
   # def __str__(self) :
    #    return self.__aerolinea,self.__origen,self.__destino,
          #self.__duracion,self.__escala,self.__clase,self.__precio
